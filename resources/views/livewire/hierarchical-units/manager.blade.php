...
<script>
        ...
        Alpine.data('hospitalBoard', (initialMap, unitsData) => ({
            ...
            init() {
                ...
                window.addEventListener('open-context-menu', (e) => {
                    // Controlamos los límites de la pantalla para que el menú no se corte (220 ancho x 150 alto)
                    let x = e.detail.x + 5;
                    let y = e.detail.y + 5;
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        // Estética "Tailwind" aplicada al Grafo
        const options = {
            ...
            nodes: {
                ...
                font: {
                    ...
                    multi: 'html',
                    bold: { size: 14, color: '#1e293b' }, // Nombre oscuro y grande
                    italic: { size: 10, color: '#64748b', mod: 'normal' } // Tipo gris y pequeño (sin inclinar)
                },
                color: {
                    background: '#ffffff',
                    border: '#06b6d4', // brand-cyan
        ...
        network.on("click", function (params) {
            if (params.nodes.length > 0) {
                ...
                document.querySelector('[x-data]').__x.$data.closeContextMenu();
            }
        });
